            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-6">
                  Süleyman Çelebi Camii is sinds 1979 gevestigd in het hart van
                  Gorinchem en maakt deel uit van de Hollanda Diyanet Vakfi.
                  Onze moskee is een spiritueel en sociaal middelpunt waar
                  moslims samenkomen voor gebed, rust en verbinding binnen de
                  gemeenschap.
                </p>
                <p className="text-gray-700 mb-6">
                  Naast dagelijkse gebeden bieden we diverse diensten aan, zoals
                  Koranlessen voor kinderen, begeleiding bij islamitische
                  huwelijken en ondersteuning bij uitvaarten. Ook organiseren we
                  activiteiten voor vrouwen via onze vrouwencommissie, waarbij
                  educatie en samenzijn centraal staan.
                </p>
                <p className="text-gray-700 mb-8">
                  Met aandacht voor religieuze en maatschappelijke behoeften
                  streven wij ernaar een plek te zijn waar iedereen zich welkom
                  voelt en zich kan ontwikkelen binnen een hechte gemeenschap.
                </p>
                <Button variant="default">Lid worden</Button>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-8">
                  Bij Süleyman Çelebi Camii staan onderwijs en gemeenschap
                  centraal. Wij begeleiden kinderen bij het leren lezen van de
                  Koran en het ontwikkelen van islamitische waarden. Onze visie
                  is om een sterke generatie op te bouwen die geworteld is in
                  hun geloof en betrokken is bij de samenleving.
                </p>
                <ul className="space-y-4 mb-8">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="text-[#CD3A2F] text-xl">•</span>
                    <span className="text-gray-700">
                      Activiteiten en bijeenkomsten speciaal voor vrouwen
                    </span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-[#CD3A2F] text-xl">•</span>
                    <span className="text-gray-700">
                      Samen bouwen aan een sterke en hechte gemeenschap
                    </span>
                  </li>
                </ul>
                <Button
          ...
          <section className="mt-24">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-gray-700 max-w-3xl mx-auto">
                Ons toegewijde team werkt hard om de moskee goed te beheren en
                de gemeenschap te ondersteunen. Zij staan klaar om alles soepel
                en georganiseerd te laten verlopen.
              </p>
            </div>
